...
const UserCard: FC<UserCardType> = ({
	...
	return (
		<Col className='d-flex align-items-center' sm='6' md='6' lg='6' justify-content='flex-start'>
			<CheckBox
				className='pe-3'
				checked={Boolean(selectedContacts.find((item) => item.id === id))}
			...
			<div className='user-details'>
				{img !== null && img?.url.length > 0 ? (
					...
					<FontAwesomeIcon className='user-avatar__placeholder' icon={faCircleUser as IconProp} />
				)}
